...
export default function AdminDashboard() {
        ...
        { text: "Tidak", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert(
                "Berhasil",
                `Status berhasil diperbarui menjadi: ${nextStatus.toUpperCase()}`,
              );
              fetchData();
            } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <View style={styles.menuBox}>
            {/* ⚙️ TOMBOL 1: Diubah menjadi Pengaturan */}
            <TouchableOpacity
              style={styles.menuItem}
              onPress={() => {
                setMenuVisible(false);
                router.push("/(admin)/settingscreen");
              }}
            >
            ...
            {/* 🚪 TOMBOL 2: Tetap asli milik kamu (Tidak Diubah) */}
            <TouchableOpacity
              style={styles.menuItem}
              onPress={() => {
                setMenuVisible(false);
      ...
      <TouchableOpacity
        style={styles.primeActionButton}
        onPress={() => router.push("/(admin)/tambah_pesan")}
      >
          ...
          renderItem={({ item }) => (
            <View style={styles.neoOrderCard}>
              <View style={styles.cardMainHeader}>
                <View>
                  <Text style={styles.neoCustName}>
                    {item.customer?.username || "Tanpa Nama"}
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    ...
                    {
                      backgroundColor:
                        item.status.toLowerCase() === "diambil"
                          ? "#E8F5E9"
                          : "#FFF3E0",
                    },
                  ]}
              ...
              <View style={styles.neoActionRow}>
                ...
                >
                  <View
                    style={[styles.iconCircle, { backgroundColor: "#EFEBE9" }]}
                  >
